        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button onClick={() => router.push('/client/services')} className="text-gray-400 text-sm hover:text-white transition-colors">
                  Product
                </button>
              </li>
              <li>
                <button onClick={() => router.push('/client/home')} className="text-gray-400 text-sm hover:text-white transition-colors">
                  Information
                </button>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button className="text-gray-400 text-sm hover:text-white transition-colors">Site Map</button>
              </li>
            </ul>
          </div>
