    ...
    <ProviderLayout title="Job Details" subtitle="Wednesday, 14 March 2025">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[12px] text-[#9CA3AF] mt-0.5">Party Makeup · Bandra West</p>
        </div>
        <Badge
          variant="outline"
          ...
          <Card className="border border-[#EBEBEB] shadow-none bg-white">
            <CardContent className="p-5 md:p-6">
              ...
              <div className="flex items-center gap-4 mb-5">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-[17px] text-[#1A1A1A]">Ananya Singh</h3>
                  <p className="text-[12px] text-[#9CA3AF] mt-0.5">Party Makeup · 90 min</p>
                </div>
              ...
              <div className="flex items-start gap-2.5 text-[13px] text-[#6B7280] mb-5 bg-[#F5F4F2] rounded-xl px-3.5 py-3 border border-[#EBEBEB]">
                ...
                <span>42, Sea View Apartments, Bandra West, Mumbai</span>
              </div>
            ...
            <div className="md:hidden">
              <Card className="border border-green-200 bg-green-50 shadow-none">
                <CardContent className="p-5 text-center">
                  ...
                  <p className="font-bold text-[32px] text-green-700">₹1,999</p>
                </CardContent>
              </Card>
            </div>
          )}
          ...
          >
            ...
            <div className="flex items-center gap-3 mt-4 pt-4 border-t border-white/15">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-white/80 text-[12px]">90 min</span>
              </div>
              <div className="w-px h-3 bg-white/20" />
              <div className="flex items-center gap-1.5">
                <MapPin className="w-3.5 h-3.5 text-white/60" />
                <span className="text-white/80 text-[12px]">Bandra West</span>
              </div>
            </div>
          </div>
